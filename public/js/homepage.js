...
var init_contact_us = function init_contact_us() {
  var contact_us = $("#contact-us-form");
  contact_us.on("submit", function () {
    ...
    $.ajax({
      ...
      error: function error(e) {
        modal.show();
        description.text(e.responseJSON ? e.responseJSON.message : "Unkown Error!");
        contact_us.removeAttr("disabled");
      }
    });
  });
  ...
  var targetEl = document.getElementById("contact-us-modal");
  ...
  var mEl = $(targetEl);
  mEl.find("#dismiss").on("click", function () {
    return modal.hide();
  });
  var description = mEl.find("#description");
};
$(function () {
  init_carousel();
  init_contact_us();
