...
@endpush
{{-- Banner --}}
<div class="md:w-full bg-[url('/img/our-business/oil-and-gas/oil_and_gas_banner.jpg')] bg-no-repeat bg-cover bg-top flex mt-[61px] md:mt-[77px]">
    ...
    <div class="item">
      <div class="item-i-bl">
        <div class="item-i-bl-ar">
          <img class="item-i-bl-i" src="{{ asset('img/our-business/oil-and-gas/pom.png') }}" alt="">
        </div>
      </div>
  ...
  <div class="item reverse">
    <div class="item-i-bh">
      <div class="item-i-bh-ar">
        <img class="item-i-bl-i" src="{{ asset('img/our-business/oil-and-gas/gas.jpg') }}" alt="">
      </div>
    </div>
