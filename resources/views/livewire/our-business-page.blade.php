@push('styles')
<link href="{{ mix('css/our-business.css') }}" rel="stylesheet">
@endpush
{{-- Banner --}}
<div class="main-banner mt-[61px] md:mt-[77px]">
  <picture>
    <source srcset="{{ mix("img/our-business/OB_banner.jpeg") }}" />
    <img alt="" />
  </picture>
...
@endcomponent
<div class="falga-container flex flex-col md:flex-row md:items-center py-5 md:py-10">
  <div class="epci-image md:my-4">
    <div class="epci-image-ar">
      <div class="epci-image-b"></div>
      <img class="lozad epci-image-i" data-src="{{ mix('img/our-business/epci.png') }}" alt="">
    </div>
  </div>
  <div class="font-poppins flex-1 mt-4 md:mb-4 md:px-16">
    <div class="falga-section-title red-falga mb-2 md:mb-4">ENGINEERING, PROCUREMENT, CONSTRUCTION AND INSTALLMENT (EPCI)</div>
...
<div class="bg-gray-100">
  <div class="falga-container flex flex-col -z-9 py-5 md:py-10">
    <div class="ogr-image md:my-4">
      <div class="ogr-image-ar">
        <div class="ogr-image-b"></div>
        <img class="lozad ogr-image-i" data-src="{{ mix('img/our-business/oil-gas.png') }}" alt="">
      </div>
    </div>
...
<div class="falga-container flex flex-col md:flex-row py-5 md:py-10">
  <div class="ier-image md:order-last my-4">
    <div class="ier-image-ar">
      <div class="ier-image-b"></div>
      <img class="lozad ier-image-i" data-src="{{ mix('img/our-business/industrial.jpeg') }}" alt="">
    </div>
  </div>
  <div class="font-poppins mt-4 md:mb-4 md:basis-1/2 md:px-16">
...
<div class="bg-gray-100">
  <div class="falga-container flex flex-col md:flex-row py-5 md:py-10">
    <div class="pah-image md:my-4">
      <div class="pah-image-ar">
        <div class="pah-image-b"></div>
        <img class="lozad pah-image-i" data-src="{{ mix('img/our-business/hospitality.jpg') }}" alt="">
      </div>
    </div>
    <div class="font-poppins mt-4 md:mb-4 md:basis-1/2 md:px-16">
...
<div class="falga-container flex flex-col py-5 md:py-10">
  <div class="fb-image md:my-4">
    <div class="fb-image-ar">
      <div class="fb-image-b"></div>
      <img class="lozad fb-image-i" data-src="{{ mix('img/our-business/future.jpg') }}" alt="">
    </div>
  </div>
