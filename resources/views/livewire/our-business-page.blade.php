    ...
    <div class="falga-container flex flex-col -z-9 md:pt-10">
        <div class="flex relative h-[200px] md:h-[576px] md:basis-1/2">
            <div class="w-[80%] md:h-[400px] md:w-[500px] m-auto z-10">
                <img class="object-cover object-right md:h-full" src="{{ asset('img/our-business/oil-gas.png') }}" alt="">
            </div>
            <div class="absolute -bottom-1 left-6 md:-bottom-8 md:left-[27%] bg-[#A55067] h-[70%] w-[80%] md:w-[35%] md:h-[90%]"></div>
        </div>
