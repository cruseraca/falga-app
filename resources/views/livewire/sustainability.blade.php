        ...
        <div class="mb-4 falga-section-title red-falga overflow-auto">
            <ul class="flex md:flex-col items-stretch" id="esg-tab" role="tablist">
                <li class="mr-2 md:mr-0 min-w-[280px]" role="presentation">
                    <a href="{{ url("sustainability?q=report#breadrumbs") }}" class="{{ $q == "report" ? "falga-tab-active" : "" }} inline-block p-2 md:p-6 border-b-2 w-full whitespace-nowrap" id="sustainability-tab" type="button" role="tab" aria-controls="sustainability" aria-selected="false">Report</a>
                </li>
                <li class="min-w-[280px]" role="presentation">
                    <a href="{{ url("sustainability?q=system#breadrumbs") }}" class="{{ $q == "system" ? "falga-tab-active" : "" }} inline-block p-2 md:p-6 border-b-2 w-full whitespace-nowrap" id="presentation-tab" type="button" role="tab" aria-controls="presentation" aria-selected="false">System</a>
                </li>
