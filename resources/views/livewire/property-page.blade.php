...
<div class="flex flex-col my-4 md:relative">
    ...
    <div class="font-poppins relative w-[85%] mx-auto bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 overflow-hidden md:absolute md:z-20 md:top-[50%] md:left-[10%] md:w-[575px]">
        ...
        <div class="py-6 pl-10 pr-6">
            <h5 class="mb-4 text-2xl font-bold tracking-tight text-rose-900">BUDGET LODGES</h5>
            <p class="font-normal text-justify">FALGA owns and manages several budget lodges that offer comfortable & affordable residences with well maintained rooms & professional staff. Our house accommodation are fully furnished and equipped with friendly amenities such as Wifi, laundry facilities, coffee maker, smart lock, etc. We strive to provide pleasant and enjoyable experience to our tenants with competitive price.</p>
        </div>
    </div>
</div>
<div class="flex flex-col py-4 bg-gray-100 md:relative">
    <div class="flex flex-col relative h-[720px] w-full md:h-screen">
        <div class="absolute bg-[#584B8F] h-[90%] w-[20%] bottom-[50%] translate-y-1/2 left-[10%] md:left-[5%] md:bottom-[55%]">
        </div>
        <div class="z-10 w-[70%] h-[40%] mx-auto mt-[20%] md:ml-[10%] md:m-0 md:mr-auto md:mt-[5%] md:h-[400px] md:w-[60%]">
            <img class="object-cover h-full w-full" src="{{ asset('/img/our-business/prop-and-hospitality/house1.jpg') }}" alt="">
        </div>
        <div class="z-[11] w-[70%] h-[40%] mx-auto my-4 md:left-[15%] md:top-[40%] md:h-[260px] md:w-[372px] md:absolute">
            <img class="object-cover h-full w-full" src="{{ asset('/img/our-business/prop-and-hospitality/house2.jpg') }}" alt="">
        </div>
    </div>
    <div class="font-poppins relative w-[85%] mx-auto bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 overflow-hidden md:absolute md:z-20 md:top-[50%] md:right-[10%] md:w-[575px]">
        ...
        <div class="py-6 pl-6 pr-10">
            <h5 class="mb-4 text-2xl font-bold tracking-tight text-rose-900">BOARDING HOUSES</h5>
            <p class="font-normal text-justify">FALGA owns and manages multiple boarding houses (guest houses) ranging from 15- to 35-room boarding houses. We offer ready-to-live-in rooms designed to accommodate our tenants for short-term or long stay. Our rooms are equipped with IoT enabled smart lock and smart TV to provide pleasant experience for our tenants.</p>
        </div>
    </div>
</div>
