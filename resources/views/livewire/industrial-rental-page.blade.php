{{-- Banner --}}
<div
    class="md:w-full bg-[url('/img/industrial-rental/banner.jpeg')] bg-no-repeat bg-cover bg-center flex mt-[61px] md:mt-[77px]">
...
<div class="container mx-auto p-10 my-10">
    <p class="font-sans text-[16px] text-justify">We provide industrial machinery and construction equipment rental services with functionality and quality. Our group offers wide assortment of industrial tools from ordinary machines to Specialized tools. We also offer full-service delivery by providing routine maintenance by our technicians on the construction equipment and tool rentals. The following are 6 categories of our Industrial Equipment Rental.</p>
</div>
<div class="bg-gray-100 py-4 flex flex-col md:flex-row md:w-full md:flex-row-reverse md:py-10 md:items-center">
    ...
    <div class="w-[90%] h-[8px] bg-[#595897] mx-auto rounded-[12px] my-2 md:w-[8px] md:h-[300px] md:mx-4"></div>
...
<div class="py-4 flex flex-col md:flex-row md:w-full md:flex-row-reverse md:py-10 md:items-center">
    ...
    <div class="w-[90%] h-[8px] bg-[#A55067] mx-auto rounded-[12px] my-2 md:w-[8px] md:h-[300px] md:mx-4"></div>
    <div class="md:w-[45%] md:p-4">
        <div class="w-[85%] mx-auto bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 overflow-hidden md:w-full">
            <div class="py-6 pl-10 pr-6">
...
<div class="bg-gray-100 py-4 flex flex-col md:flex-row md:w-full md:flex-row-reverse md:py-10 md:items-center">
    ...
    <div class="w-[90%] h-[8px] bg-[#8B547D] mx-auto rounded-[12px] my-2 md:w-[8px] md:h-[300px] md:mx-4"></div>
    <div class="md:w-[45%] md:p-4">
        <div class="w-[85%] mx-auto bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 overflow-hidden md:w-full">
            <div class="py-6 pl-10 pr-6">
...
<script src="{{ asset('js/industrial-rental.js') }}"></script>
@endpush