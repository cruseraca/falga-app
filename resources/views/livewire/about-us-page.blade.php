...
<div id="key-person" class="falga-container pt-16 md:pt-20">
  ...
  <div class="flex flex-wrap flex-col-reverse divide-transparent justify-center items-stretch">
    <x-managing-partner-item name="Tommy Hesarid Simamora, B.SC, MBA" position="Partner" image="{{ url('/img/about-us/tommy.jpeg') }}" description="Tommy Simamora is an investment executive & entrepreneur with expertise in the fields of Corporate Management, Investment Banking/Management and Private Equity. He accumulated work experiences in top global companies in United States such as Morgan Stanley US & Wells Fargo Securities US where he was involved in M&A, securitization, and capital raising transactions. Prior to leading FALGA Group in 2022, he started working professionally for KPMG Indonesia in 2014 when he moved back for good to Indonesia. He joined Mandiri Investasi in 2015 which is Indonesian largest asset management company with more than IDR 75 trillion ($5 Billion) in consolidated AUM as General Partner for Private Equity & Infrastructure (listed & non-listed) funds. Through these funds, he was involved in the leadership board of multiple investee companies e.g., Chairman position in the sub-holding / subsidiary of PT Jasa Marga (Persero) Tbk., as well as other State-Owned Enterprises' subsidiaries and strategic holding companies."></x-managing-partner-item>
