...
@endpush
{{-- Banner --}}
<div class="lozad sm:w-full falga-banner bg-no-repeat bg-center bg-cover flex mt-[61px] md:mt-[77px] items-center justify-center" data-background-image="{{ mix('img/projects-portfolio/banner.jpg') }}">
