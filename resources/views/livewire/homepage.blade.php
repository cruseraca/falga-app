...
<div class="max-w-screen flex flex-col mx-auto my-6 md:my-20 font-poppins">
    <div class="flex flex-col md:relative md:h-[600px] w-full">
        ...
        <div
            class="text-center my-4 md:absolute md:text-right md:text-xl md:left-[260px] xl:left-[360px] top-[150px] text-[#ac5e72] font-black md:transform md:-translate-x-1/2 md:-translate-y-1/2"
        >
            <a href="#"> Industrial<br />Equipment Rental </a>
        </div>
        <div
            class="flex justify-center md:absolute w-screen sm:w-[400px] md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2"
        >
            <img
                class="w-2/3 md:w-full contain"
                src="{{ asset('img/homepage/glance.png') }}"
                alt=""
            />
        </div>
        <div
            class="text-center my-4 md:absolute md:text-xl right-[35px] xl:right-[185px] top-[280px] text-[#816092] font-black md:transform md:-translate-x-1/2 md:-translate-y-1/2"
        >
            <a href="#"> Oil & Gas Service </a>
        </div>
        <div
            class="text-center my-4 md:absolute md:text-right md:text-xl left-[100px] xl:left-[200px] bottom-[200px] text-[#646EA6] font-black md:transform md:translate-x-1/2 md:translate-y-1/2"
        >
            <a href="#"> Property and<br />Hospitality </a>
        </div>
        <div
            class="text-center my-4 md:absolute md:text-xl right-[120px] xl:right-[220px] bottom-[140px] text-[#68609B] font-black md:transform md:-translate-x-1/2 md:translate-y-1/2"
        >
            <a href="#"> Future Business </a>
        </div>
    </div>
    <div
        class="flex flex-col divide-y-2 px-6 md:flex-row md:divide-x-2 md:divide-y-0 divide-black font-sans text-sm md:text-base"
    >
...
<div class="container mx-auto my-10 sm:my-20">
    ...
    <div class="flex flex-col sm:flex-row justify-between gap-4 px-20 sm:px-0">
        <div
            class="flex flex-col w-auto rounded-lg border py-5 shadow-box text-center"
        >
        ...
        <div
            class="flex flex-col w-auto rounded-lg border py-5 px-2 shadow-box text-center"
        >
            <div class="my-auto mx-6 xl:mx-16">
    ...
    <div
        class="flex flex-col sm:flex-row justify-between my-4 sm:my-10 gap-4 px-20 sm:px-0"
    >
        <div
            class="flex flex-col w-auto rounded-lg border py-5 px-2 shadow-box text-center"
        >
        ...
        <div
            class="flex flex-col w-auto sm:w-1/4 rounded-lg border py-5 px-2 shadow-box text-center"
        >
            <div class="my-auto mx-6 xl:mx-16">
                <p class="font-black text-md">
...
{{-- Recent Update --}}
{{--
<div class="bg-violet-falga my-20">
    <div
        class="container flex flex-row mx-auto py-20 px-[64px] justify-between"
    >
        <div class="w-1/3 pl-40 mr-10">
            <h1 class="text-white font-poppins text-[36px] mt-12">
                Recent Updates
            </h1>
            <h1 class="text-white my-10 text-justify">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                Dolores quas in illo, praesentium a porro tenetur sunt sequi
                quasi, magnam enim. Quod aspernatur atque beatae est incidunt
                eum maiores temporibus!
            </h1>
            <a
                href="#"
                class="inline-block px-8 py-2 leading-none rounded-[8px] bg-white text-violet-falga border-white hover:border-purple-falga hover:text-purple-falga hover:bg-white lg:mt-0"
                >See All</a
            >
        </div>
        <div class="flex">
            <div
                class="w-[320px] h-[448px] rounded-xl bg-white mx-8 overflow-hidden"
            >
                <div class="h-[242px] w-full">
                    <img
                        src="{{ asset('img/update-01.jpeg') }}"
                        class="h-full w-full"
                    />
                </div>
                <div class="w-full p-5">
                    ...
                    <p class="mt-3 h-[56px] text-justify text-sm line-clamp-3">
                        Lorem ipsum dolor sit amet consectetur, adipisicing
                        elit. Itaque debitis architecto temporibus quas neque
                        adipisci tempora laboriosam amet eligendi, dolore nisi
                        incidunt! Quo maxime quam corporis eius alias, esse
                        veniam neque quis repellendus repudiandae animi eos
                        ipsam ad incidunt cupiditate mollitia exercitationem
                        distinctio ipsa quae. Vero possimus doloremque maxime
                        veniam.
                    </p>
                    <p
                        class="mt-3 h-[56px] text-justify text-sm underline text-red-900"
                    >
                        Read more
                    </p>
                </div>
        ...
        <div class="flex">
            <span class="fa-stack fa-xl my-auto">
                ...
                <i
                    class="fa-solid fa-angle-right fa-stack-1x text-violet-falga"
                ></i>
            </span>
        </div>
    </div>
...
<div class="container mx-auto sm:my-20 sm:px-6">
    ...
    <div class="sm:relative flex">
        <div
            class="flex absolute invisible sm:visible left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 carousel-button-left cursor-pointer"
        >
            <span class="fa-stack fa-xl my-auto">
        ...
        <div class="carousel sm:w-[85%] mx-auto w-screen">
            ...
            <div
                class="carousel-cell w-2/3 sm:w-[30%] mx-1 sm:mx-4 rounded-xl flex overflow-hidden"
            >
                <div class="h-full">
                    <img
                        src="{{ asset('img/slider/image-1.jpeg') }}"
                        class="h-full object-cover object-center-bottom"
                    />
                </div>
                <div
                    class="absolute bottom-10 inset-x-0 text-white text-center text-lg"
                >
            ...
            >
                <div class="h-full">
                    <img
                        src="{{ asset('img/slider/image-6.jpg') }}"
                        class="h-full object-cover object-center-bottom"
                    />
                </div>
                <div
            ...
            >
                <div class="h-full w-full">
                    <img
                        src="{{ asset('img/slider/image-4.jpeg') }}"
            ...
            >
                <div class="h-full w-full">
                    <img
                        src="{{ asset('img/slider/image-5.jpeg') }}"
                        class="h-full w-full object-fill"
                    />
                </div>
                <div
    ...
    <div class="text-center my-10">
        <a
            href="#"
            class="inline-block text-sm px-4 py-2 leading-none border rounded-[8px] bg-purple-falga text-white border-white hover:border-purple-falga hover:text-purple-falga hover:bg-white mt-4 lg:mt-0"
            >See All Bussiness</a
        >
    </div>
</div>
...
<div class="container mx-auto my-8 px-8 sm:px-20">
    <div class="text-center sm:my-8">
        <p class="text-2xl sm:text-3xl text-red-falga font-black font-poppins">
            Clients & Partners
        </p>
    </div>
    <div class="flex flex-row sm:flex-col w-full">
        <div class="flex flex-col w-1/2 sm:w-full sm:flex-row justify-between">
            <div class="h-20 sm:h-40 w-4/5 sm:w-1/6 sm:w-1/4 mx-4">
                <img
                    src="{{ asset('img/logo/logo-pertamina.png') }}"
                    alt=""
                    class="h-full w-full object-contain"
                />
            </div>
            <div class="h-20 sm:h-40 w-4/5 sm:w-1/6 mx-4">
                <img
                    src="{{ asset('img/logo/logo-pgn.png') }}"
                    alt=""
                    class="h-full w-full object-contain"
                />
            </div>
            <div
                class="flex h-20 sm:h-40 w-4/5 sm:w-1/6 mx-4 items-center justify-center"
            >
                <img
                    src="{{ asset('img/logo/logo-wika.png') }}"
                    alt=""
            ...
            >
                <img
                    src="{{ asset('img/logo/logo-waskita.png') }}"
                    alt=""
                    class="h-[60%] object-contain"
                />
            </div>
            <div class="flex h-20 sm:h-40 w-4/5 sm:w-1/6 mx-4 items-center">
                <img
                    src="{{ asset('img/logo/logo-schneider.png') }}"
                    alt=""
            ...
            <div class="flex h-20 sm:h-40 w-4/5 sm:w-1/6 mx-4 items-center">
                <img
                    src="{{ asset('img/logo/logo-yokogawa.png') }}"
                    alt=""
                    class="w-full object-contain"
                />
            </div>
        ...
        <div class="flex flex-col w-1/2 sm:w-full sm:flex-row justify-between">
            <div class="h-20 sm:h-40 w-4/5 sm:w-1/6 mx-6 items-center">
                <img
                    src="{{ asset('img/logo/logo-endress.png') }}"
                    alt=""
                    class="h-full w-full object-contain"
                />
            </div>
            <div class="h-20 sm:h-40 w-4/5 sm:w-1/6 mx-6 items-center">
                <img
                    src="{{ asset('img/logo/logo-patterson.png') }}"
                    alt=""
                    class="h-full w-full object-contain"
                />
            </div>
            <div class="h-20 sm:h-40 w-4/5 sm:w-1/6 mx-6 items-center">
                <img
                    src="{{ asset('img/logo/logo-akzonobel.png') }}"
                    alt=""
                    class="h-full w-full object-contain"
                />
            </div>
            <div class="h-20 sm:h-40 w-4/5 sm:w-1/6 mx-6 items-center">
                <img
                    src="{{ asset('img/logo/logo-kansai.png') }}"
                    alt=""
                    class="h-full w-full object-contain"
                />
            </div>
            <div class="h-20 sm:h-40 w-4/5 sm:w-1/6 mx-6 items-center">
                <img
                    src="{{ asset('img/logo/logo-sulzer.png') }}"
                    alt=""
                    class="h-full w-full object-contain"
                />
            </div>
            <div class="h-20 sm:h-40 w-4/5 sm:w-1/6 mx-6 items-center">
                <img
                    src="{{ asset('img/logo/logo-comeca.png') }}"
                    alt=""
                    class="h-full w-full object-contain"
                />
            </div>
...
{{-- Contact Us --}}
<div
    class="w-full bg-[url('/img/homepage/background-contact.jpeg')] bg-cover bg-no-repeat"
>
    <div class="container mx-auto sm:py-16">
        <div class="flex flex-col sm:flex-row w-full">
            <div class="w-full order-last sm:order-first mb-10">
                <p
                    class="text-2xl sm:text-3xl text-red-falga font-black font-poppins text-center my-10"
                >
                    Site Map
                </p>
            ...
            <div class="w-full p-10">
                <p
                    class="text-2xl sm:text-3xl text-red-falga font-black font-poppins text-center mb-10"
                >
                    Contact Us
                </p>
                <form>
                    <div class="mb-6">
                        <label class="block text-md font-medium text-red-falga"
                            >Full Name</label
                        >
                        <input
                    ...
                    <div class="mb-6">
                        <label
                            for="email"
                            class="block text-md font-medium text-red-falga"
                            >Email</label
                        >
                        <input
                            type="email"
                    ...
                    <div class="text-center">
                        <button
                            type="submit"
                            class="text-white bg-purple-falga hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2 text-center"
                        >
                            Submit
                        </button>
                    </div>
