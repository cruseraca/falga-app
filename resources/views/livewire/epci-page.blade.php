...
<div class="falga-container">
    ...
    <div class="falga-wd mb-14">
        <img src="{{ url('img/epci-business/civil.png') }}" class="falga-wd-civil" data-popover-target="popover-civil" data-popover-trigger="hover" data-popover-placement="bottom" />
        ...
        <img src="{{ url('img/epci-business/electrical.png') }}" class="falga-wd-electrical" data-popover-target="popover-electrical" data-popover-trigger="hover" data-popover-placement="bottom" />
        ...
        <img src="{{ url('img/epci-business/instrumentation.png') }}" class="falga-wd-instrumentation" data-popover-target="popover-instrumentation" data-popover-trigger="hover" data-popover-placement="bottom" />
        ...
        <img src="{{ url('img/epci-business/work-division.png') }}" class="falga-wd-c" />
        <img src="{{ url('img/epci-business/mechanical.png') }}" class="falga-wd-mechanical" data-popover-target="popover-mechanical" data-popover-trigger="hover" data-popover-placement="bottom" />
        ...
        <img src="{{ url('img/epci-business/automation.png') }}" class="falga-wd-automation" data-popover-target="popover-automation" data-popover-trigger="hover" data-popover-placement="bottom" />
        ...
        <img src="{{ url('img/epci-business/others.png') }}" class="falga-wd-others" data-popover-target="popover-others" data-popover-trigger="hover" data-popover-placement="bottom" />
