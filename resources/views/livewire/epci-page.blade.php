...
<div class="sm:w-full falga-banner bg-no-repeat bg-cover bg-top flex mt-[61px] md:mt-[77px]">
    <div class="falga-container text-center h-[400px] lg:h-[766px] text-white flex flex-col justify-end items-center" style="margin-bottom: 226px">
...
<x-epci-item
    ...
    color="#5063A1"
    image="{{ url('img/epci-business/engineering.jpeg') }}"
></x-epci-item>
<x-epci-item
    title="PROCUREMENT"
    ...
    color="#972540"
    image="{{ url('img/epci-business/procurement.jpeg') }}"
    reverse="true"
></x-epci-item>
<x-epci-item
    title="CONSTRUCTION"
    ...
    color="#7D5082"
    image="{{ url('img/epci-business/construction.jpeg') }}"
></x-epci-item>
<x-epci-item
    title="INSTALLATION"
    ...
    color="#584B8F"
    image="{{ url('img/epci-business/installation.jpeg') }}"
    reverse="true"
></x-epci-item>
